...
Same discipline as Phase A (``jev_md.judgment.batch``) and Phase C
(``jev_md.audit.batch``): greedy fill in original order while the
...
from jev_md.judgment.batch import Batch, BatchError
...
from jev_md.judgment.tokens import estimate_tokens, json_chars
from jev_md.thresholds import BATCH_TOKEN_BUDGET, CHARS_PER_TOKEN
