...
Same discipline as Phase A (``jevmory.judgment.batch``) and Phase C
(``jevmory.audit.batch``): greedy fill in original order while the
...
from jevmory.judgment.batch import Batch, BatchError
